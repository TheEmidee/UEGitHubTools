...
bool FGitHubToolsHttpRequestData_SubmitPRReview::UsesGraphQL() const
{
    return true;
}
...
FText FGitHubToolsHttpRequestData_SubmitPRReview::GetNotificationText() const
{
    return LOCTEXT( "SubmitPRReview", "Submit a PR review" );
}

FText FGitHubToolsHttpRequestData_SubmitPRReview::GetFailureText() const
{
    return LOCTEXT( "SubmitPRReview", "Error while submitting a PR review" );
}

void FGitHubToolsHttpResponseData_SubmitPRReview::ParseResponse( FHttpResponsePtr response_ptr )
{
