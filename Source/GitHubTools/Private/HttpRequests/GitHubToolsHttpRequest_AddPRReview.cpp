...
FText FGitHubToolsHttpRequestData_AddPRReview::GetNotificationText() const
{
    return LOCTEXT( "AddPRReview", "Creating a new review" );
}

FText FGitHubToolsHttpRequestData_AddPRReview::GetFailureText() const
{
    return LOCTEXT( "AddPRReview", "Error while creating a new review" );
}

void FGitHubToolsHttpResponseData_AddPRReview::ParseResponse( FHttpResponsePtr response_ptr )
{
