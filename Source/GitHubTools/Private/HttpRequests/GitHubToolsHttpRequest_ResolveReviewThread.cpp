...
FText FGitHubToolsHttpRequestData_ResolveReviewThread::GetNotificationText() const
{
    return LOCTEXT( "GetPullRequestReviews", "Fetching the reviews of the pull request" );
}

FText FGitHubToolsHttpRequestData_ResolveReviewThread::GetFailureText() const
{
    return LOCTEXT( "GetPullRequestReviews", "Error while fetching the reviews of the pull request" );
}

void FGitHubToolsHttpResponseData_ResolveReviewThread::ParseResponse( FHttpResponsePtr response_ptr )
{
